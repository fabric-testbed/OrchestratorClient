...
class SliversApi(object):
    ...
    def slivers_poa_sliver_id_request_id_get(self, sliver_id, request_id, **kwargs):  # noqa: E501
        """Perform an operational action on a sliver.  # noqa: E501

        Request get the status of the POA identified by request_id.     # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.slivers_poa_sliver_id_request_id_get(sliver_id, request_id, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str sliver_id: Sliver identified by universally unique identifier (required)
        :param str request_id: Request Id for the POA triggered (required)
        :return: Poa
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.slivers_poa_sliver_id_request_id_get_with_http_info(sliver_id, request_id, **kwargs)  # noqa: E501
        else:
            (data) = self.slivers_poa_sliver_id_request_id_get_with_http_info(sliver_id, request_id, **kwargs)  # noqa: E501
            return data

    def slivers_poa_sliver_id_request_id_get_with_http_info(self, sliver_id, request_id, **kwargs):  # noqa: E501
        """Perform an operational action on a sliver.  # noqa: E501

        Request get the status of the POA identified by request_id.     # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.slivers_poa_sliver_id_request_id_get_with_http_info(sliver_id, request_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['sliver_id', 'request_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method slivers_poa_sliver_id_request_id_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'sliver_id' is set
        if ('sliver_id' not in params or
                params['sliver_id'] is None):
            raise ValueError("Missing the required parameter `sliver_id` when calling `slivers_poa_sliver_id_request_id_get`")  # noqa: E501
        # verify the required parameter 'request_id' is set
        if ('request_id' not in params or
                params['request_id'] is None):
            raise ValueError("Missing the required parameter `request_id` when calling `slivers_poa_sliver_id_request_id_get`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/slivers/poa/{sliver_id}/{request_id}', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
